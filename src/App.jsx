                              ...
                              return (
                                <React.Fragment key={p.id}>
                                  ...
                                  <div role="button" tabIndex={0}
                                    ...
                                    className={(() => { const _layout = isLastLodge ? 'flex flex-col' : 'grid grid-cols-[4.5rem_1fr_auto]'; const _state = p._timingConflict ? 'bg-red-50/85 shadow-[0_8px_18px_-16px_rgba(239,68,68,0.55)] hover:bg-red-100/80' : isLastLodge ? 'mt-2 bg-[linear-gradient(180deg,rgba(238,242,255,0.95),rgba(255,255,255,0.98))] shadow-[0_14px_24px_-20px_rgba(99,102,241,0.28)]' : isActive ? 'bg-[linear-gradient(180deg,rgba(239,246,255,0.95),rgba(255,255,255,0.98))] shadow-[0_14px_24px_-18px_rgba(49,130,246,0.42)]' : `${navCatStyle.bg} ${navCatStyle.shadow} hover:brightness-[0.97]`; return `${_layout} items-center gap-1.5 rounded-[14px] border-2 px-2 py-1.5 text-left transition-colors relative overflow-hidden ${_state}`; })()}
                                    style={{ borderColor: ROUTE_PREVIEW_COLORS[dNavIdx % ROUTE_PREVIEW_COLORS.length] }}
                                  >
                                    {/* 퀵뷰 좌측 악센트 바 */}
                                    <div className={`absolute left-0 top-0 bottom-0 w-[3px] rounded-l-[14px] ${navCatStyle.accent}`} />
                                    {isLastLodge ? (
                                      <div className="grid w-full min-w-0 grid-cols-[4.5rem_1fr_auto] items-center gap-1.5">
                                  ...
                                  {p._timingConflict && navConflictRecommendation && (
                                    <div className="grid grid-cols-[4.5rem_1fr_auto] items-center gap-1.5 px-1 py-0.5">
                                      <span />
                                      <button
                                        type="button"
                                        onClick={(e) => {
                                  ...
                                  {showBufferConnector && (
                                    <div className="px-1 py-0.5">
                                      <button
                                        ...
                                        className="grid w-full grid-cols-[4.5rem_1fr_auto] items-center gap-1.5 rounded-[14px] border border-orange-300 bg-orange-400 px-2 py-1.5 text-left transition-all hover:bg-orange-500"
