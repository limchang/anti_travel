              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* ── 스크롤 영역: 카드 목록 ── */}
                    <div id="place-library-scroll" className="flex-1 overflow-y-auto overscroll-none no-scrollbar px-2 pt-2 pb-4 grid gap-2 auto-rows-min items-start content-start" style={{ gridTemplateColumns: `repeat(auto-fill, minmax(${Math.min(280, rightSidebarWidth - 20)}px, 1fr))` }}>
