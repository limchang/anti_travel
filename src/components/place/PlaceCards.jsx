...
export const PlaceEditorCard = ({
  ...
  return (
    <div
      className={`w-full rounded-2xl border border-slate-200 bg-white shadow-[0_12px_30px_-18px_rgba(15,23,42,0.25)] overflow-hidden flex flex-col ${className}`.trim()}
...
export const PlaceLibraryCard = ({
  ...
  <div
    ...
    className={`w-full group relative overflow-hidden rounded-2xl border bg-white transition-[border-color,box-shadow] duration-200 ${place._isNew ? 'border-[#3182F6] shadow-[0_0_0_4px_rgba(49,130,246,0.15),0_0_20px_-4px_rgba(49,130,246,0.2)] animate-pulse' : highlighted ? 'border-[#3182F6] ring-2 ring-[#3182F6]/25 shadow-[0_0_24px_-4px_rgba(49,130,246,0.3)]' : categoryBorder ? `${categoryBorder} shadow-[0_8px_24px_-10px_rgba(15,23,42,0.10)] hover:shadow-[0_12px_28px_-10px_rgba(15,23,42,0.14)]` : 'border-slate-200 shadow-[0_8px_24px_-10px_rgba(15,23,42,0.10)] hover:shadow-[0_12px_28px_-10px_rgba(15,23,42,0.14)] hover:border-slate-300'} ${cardProps.className || ''}`.trim()}
  >
    {/* 카테고리 색 헤더 */}
    {categoryAccent && (
