...
export const latestUpdate = updateLog.lastUpdates[0] || { version: '0.0.0', timestamp: new Date().toISOString() };
export const APP_VERSION = latestUpdate.version;
export const LAST_PUSH_TIME = latestUpdate.timestamp;
export const formatPushTimestampLabel = (timestamp) => {
...
export const ROUTE_PREVIEW_ENABLED = true;
export const ROUTE_PREVIEW_COLORS = ['#34C759', '#FF8A3D', '#8B5CF6', '#3182F6', '#EF4444', '#14B8A6'];
