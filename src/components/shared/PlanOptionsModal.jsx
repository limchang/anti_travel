...
export default function PlanOptionsModal({
  ...
  planOptionStartDate, setPlanOptionStartDate,
  planOptionEndDate, setPlanOptionEndDate,
  planOptionBudget, setPlanOptionBudget,
  collaborators, setCollaborators,
  manualSaveHistory,
  canManagePlan,
  collaboratorLoading, setCollaboratorLoading,
  saveItineraryManually,
  restoreSaveHistory,
  setTripRegion, setTripStartDate, setTripEndDate, setItinerary,
  setShowHeroSummaryModal,
}) {
  const { setShowPlanOptions, setShowPlanManager, showSaveHistoryPanel, setShowSaveHistoryPanel } = useUIStore();
  const [collaboratorInput, setCollaboratorInput] = useState('');

  useModalKeyboard(() => setShowPlanOptions(false));
  ...
  const addCollaborator = () => {
    ...
    setCollaborators([...collaborators, { email, addedAt: Date.now() }]);
