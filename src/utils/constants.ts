...
const BULK_KW_MAP = {
  ...
  food: ['국수', '한식', '중식당', '전복요리', '고사리육개장', '일식', '양식', '중국집', '피자', '횟집', '생선회', '해물', '생선요리', '고깃집', '삼겹살', '갈비', '족발', '보쌈', '맛집', '전문점', '식당', '음식', '육류', '고기요리', '치킨', '닭강정', '햄버거', '치킨집', '우동', '소바', '해장국', '국밥', '찌개', '탕', '냉면', '칼국수', '수제비', '라멘', '돈가스', '스시', '이자카야', '포장마차', '면요리', '뷔페', '스테이크', '곱창', '막창'],
  snack: ['분식', '떡볶이', '김밥', '만두', '핫도그', '순대', '어묵', '튀김', '토스트', '호떡', '붕어빵', '패스트푸드'],
